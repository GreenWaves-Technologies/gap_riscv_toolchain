...
#define HAVE_vec_permv2hi_low (((Pulp_Cpu==PULP_GAP8) && !(TARGET_MASK_NOVECT||TARGET_MASK_NOSHUFFLEPACK)))
#define HAVE_vec_permv2hi_high (((Pulp_Cpu==PULP_GAP8) && !(TARGET_MASK_NOVECT||TARGET_MASK_NOSHUFFLEPACK)))
...
#define HAVE_cplx_conjhi2 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_cplx_conjsi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_add_div2_v2hi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_add_div2_v4qi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_add_div4_v2hi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_add_div4_v4qi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_sub_div2_v2hi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_sub_div2_v4qi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_sub_div4_v2hi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_sub_div4_v4qi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
#define HAVE_subrotmj_v2hi3 (((Pulp_Cpu==PULP_GAP8) && !TARGET_MASK_NOVECT))
